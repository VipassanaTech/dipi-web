...
$q = "select a_id, a_course, a_f_name, a_l_name from dh_applicant a left join dh_course c on (a.a_course=c.c_id) where c.c_start >= CURDATE() and c.c_auto_confirm=1 and a.a_status in ('Received') limit 200";
$result = db_query($q);
